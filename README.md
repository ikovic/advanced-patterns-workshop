...
This repository contains my notes and solutions for the Total Typescript - Advanced Patterns workshop. The original problem solutions are still in the repo, with the `.solution` suffix. My solutions and notes use the `.sol` suffix.
